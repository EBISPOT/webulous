...
import uk.ac.ebi.fgpt.populous.patterns.model.Cell;
import uk.ac.ebi.fgpt.populous.patterns.model.Sheet;
...
public class PatternSheetManager {
    ...
    private Set<SimplePopulousPattern> selectedPatterns;
...
//    private static int counter = 0;
    ...
    public Map<String, SimplePopulousPattern> parsePatterns() {
        Map<String, SimplePopulousPattern> result = new LinkedHashMap<String, SimplePopulousPattern>();
        for (int row = 0; ; row++) {
            ...
            if (cell.getValue().equals(PATTERN_ROW_KEY)) {
                SimplePopulousPattern pattern = new SimplePopulousPattern();
    ...
    public Set<SimplePopulousPattern> getPopulousPatterns() {
        return new HashSet<SimplePopulousPattern>(parsePatterns().values());
    }


    public Set<SimplePopulousPattern> getSelectedPatterns() {
        return selectedPatterns;
    }


    private void setPatterns(Map<String, SimplePopulousPattern> patternMap) {
        removeAllPatterns();
        int row = 0;
    ...
    public void addPopulousPattern(SimplePopulousPattern pattern) {
        Map<String, SimplePopulousPattern> result = parsePatterns();
        result.put(pattern.getPatternID(), pattern);
        setPatterns(result);
    }
    ...
    public void removePopulousPattern(SimplePopulousPattern pattern) {
        Map<String, SimplePopulousPattern> result = parsePatterns();
    ...
    public static void main(String[] args) {
        ...
        SimplePopulousPattern pattern1 = new SimplePopulousPattern("pattern1", "?cell:CLASS,\n" +
                "?anatomyPart:CLASS,\n" +
        ...
        SimplePopulousPattern pattern2 = new SimplePopulousPattern("pattern2", "?cell:CLASS,\n" +
                "?anatomyPart:CLASS,\n" +
                "?valueRestriction:CLASS = part_of some ?anatomyPart,\n" +
                "?anatomy:CLASS = createIntersection(?valueRestriction.VALUES)\n" +
                "BEGIN\n" +
        ...
        SimplePopulousPattern pattern3 = new SimplePopulousPattern("pattern3", "?cell:CLASS,\n" +
                "?anatomyPart:CLASS,\n" +
                "?valueRestriction:CLASS = part_of some ?anatomyPart,\n" +
                "?anatomy:CLASS = createIntersection(?valueRestriction.VALUES)\n" +
                "BEGIN\n" +
