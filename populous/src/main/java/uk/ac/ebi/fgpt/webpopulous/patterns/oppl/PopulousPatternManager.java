...
import uk.ac.ebi.fgpt.webpopulous.patterns.oppl.PopulousModel;
...
//                "END;";
            ...
            columns.add(2);
//            columns.add(3);
            model.getPopulousPatterns().add(new PopulousPattern("1", pattern));
            model.getPopulousPatterns().add(new PopulousPattern("2", pattern3));
            model.setSheet(0);
...
//            NewEntities newEntities = new NewEntities(baseURI, false, "");

            EntityCreation newEntities = new EntityCreation();
            try {
